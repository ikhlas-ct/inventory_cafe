...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 grid-margin transparent">
            <div class="row">
                ...
                <!-- Total Barang -->
                <div class="col-md-3 stretch-card transparent position-relative mb-4">
                    @if (auth()->user()->role === 'manajer')
                        <a href="{{ route('barangs.index') }}" class="stretched-link"></a>
                    @endif
                ...
                <!-- Barang Masuk -->
                <div class="col-md-3 stretch-card transparent position-relative mb-4">
                    <a href="{{ route('barangmasuks.index') }}" class="stretched-link"></a>
                ...
                <!-- Barang Keluar -->
                <div class="col-md-3 stretch-card transparent position-relative mb-4">
                    <a href="{{ route('barangkeluars.index') }}" class="stretched-link"></a>
                ...
                <div class="col-md-3 stretch-card transparent position-relative mb-4">
                    ...
                    @else
                        <a href="#" class="stretched-link"
                            onclick="alert('Fitur ini hanya untuk Manajer'); return false;"></a>
                    @endif
                            ...
                            <tbody>
                                @foreach ($criticalBarangs as $barang)
                                    <tr>
                                        ...
                                        <td>
                                            <div
                                                class="badge {{ $barang->stok_sekarang < 5 ? 'badge-danger' : 'badge-warning' }}">
                            ...
                            <div class="preview-item {{ $loop->last ? '' : 'border-bottom' }}">
                                <div class="preview-thumbnail">
                                    <div class="preview-icon bg-{{ $activity->type == 'masuk' ? 'success' : 'danger' }}">
                                        <i
                                            class="mdi mdi-{{ $activity->type == 'masuk' ? 'arrow-down-box' : 'arrow-up-box' }}"></i>
                                    </div>
                                </div>
                                <div class="preview-item-content d-sm-flex grow">
                                    <div class="grow">
                                        <h6 class="preview-subject">Barang
                                            {{ $activity->type == 'masuk' ? 'Masuk' : 'Keluar' }}:
                                            {{ $activity->nomor_transaksi }}</h6>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 position-relative">
                            @if (auth()->user()->role === 'manajer')
                                <a href="{{ route('kategoris.index') }}" class="stretched-link"></a>
                            @endif
                            <div class="d-flex align-items-center border-right justify-content-between">
                                <div>
    ...
    <style>
        ...
        /* Efek hover ringan agar terasa clickable tanpa ubah tampilan drastis */
        .position-relative:hover .card,
        .position-relative:hover .d-flex {
