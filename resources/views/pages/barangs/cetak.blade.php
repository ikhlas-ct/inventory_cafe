...
<html lang="id">
    ...
    <head>
        ...
        <title>Laporan Stok Barang - Cafe Hom Padang</title>
        <style>
...
thead {
    ...
    <body onload="window.print()">
        <div class="container">
                ...
                <table>
                    ...
                    <tbody>
                        @forelse ($expiringStocks as $key => $item)
                            <tr @if ($item['sisa_hari'] < 0) class="bg-primary text-white" @elseif ($item['sisa_hari'] < 5) class="text-white" @endif>
                                <td>{{ $key + 1 }}</td>
                                <td>{{ $item['barang']->nama }}</td>
                                <td>{{ $item['kadaluarsa']->format('d F Y') }}</td>
                                <td>{{ $item['stok'] }}</td>
            ...
            <!-- Tabel Stok Barang -->
            <h4 class="card-title mt-5">Stok Barang</h4>
            <div class="table-container">
                <table>
                    <thead>
                        <tr>
