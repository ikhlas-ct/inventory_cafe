...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('src/assets/vendors/owl-carousel-2/owl.carousel.min.css') }}">
    <link rel="stylesheet" href="{{ asset('src/assets/vendors/owl-carousel-2/owl.theme.default.min.css') }}">
  ...
  <body>
    ...
    <script src="{{ asset('src/assets/vendors/jvectormap/jquery-jvectormap.min.js') }}"></script>
    <script src="{{ asset('src/assets/vendors/jvectormap/jquery-jvectormap-world-mill-en.js') }}"></script>
    <script src="{{ asset('src/assets/vendors/owl-carousel-2/owl.carousel.min.js') }}"></script>
